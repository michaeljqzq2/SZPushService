...
namespace SZPushService.Model
{
    public class UData
    {
        ...
        static UData()
        {
            ...
            Urls.Add("Youhui", new List<string>() { "http://www.smzdm.com/youhui","UTF-8",@"<link rel=""stylesheet"" href=""http://www.smzdm.com/resources/public/css/main.css?v=20151201"" type=""text/css"">"""});
            Urls.Add("Domestic", new List<string>() { "http://www.smzdm.com/","UTF-8",@"<link rel=""stylesheet"" href=""http://www.smzdm.com/resources/public/css/main.css?v=20151201"" type=""text/css"">"""});
